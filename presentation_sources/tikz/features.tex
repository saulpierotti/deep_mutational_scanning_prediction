...
\sbox{\mutidtikzpicture}{%
	\input{tikz/mutation_simple.tex}%
}
...
\begin{tikzpicture}
	...
	\node [object, below=2em of b, text width=13em, xshift=-8em, minimum height=10em] (d) {%
	HMMER emission probabilities\\{\tiny\parencite{Eddy2011}}
	\vspace{1em}
	\begin{figure}\usebox{\hmmtikzpicture}\end{figure}
	};
	\node [object, below=2em of b, text width=13em, xshift=8em, minimum height=10em, text depth=8.1em] (e) {%
