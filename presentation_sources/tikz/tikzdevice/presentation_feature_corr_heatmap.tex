...
\begin{tikzpicture}[x=1pt,y=1pt]
	...
	\begin{scope}
		...
		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,  5.15) {\sbseries EVcouplings mutation frequency};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,  8.99) {\sbseries EVcouplings conservation};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 12.83) {\sbseries EVcouplings independent model};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 16.68) {\sbseries EVcouplings epistatic model};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 20.52) {\sbseries NetsurfP-2\hspace{.03ex} RSA};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 24.36) {\sbseries NetsurfP-2 ASA};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 28.20) {\sbseries NetsurfP-2 secondary structure $Q_3$ \texttt{H}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 32.04) {\sbseries NetsurfP-2 secondary structure $Q_3$ \texttt{E}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 35.88) {\sbseries NetsurfP-2 secondary structure $Q_3$ \texttt{C}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 39.72) {\sbseries NetsurfP-2 secondary structure $Q_8$ \texttt{G}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 43.56) {\sbseries NetsurfP-2 secondary structure $Q_8$ \texttt{H}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 47.40) {\sbseries NetsurfP-2 secondary structure $Q_8$ \texttt{I}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 51.25) {\sbseries NetsurfP-2 secondary structure $Q_8$ \texttt{B}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 55.09) {\sbseries NetsurfP-2 secondary structure $Q_8$ \texttt{E}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 58.93) {\sbseries NetsurfP-2 secondary structure $Q_8$ \texttt{S}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 62.77) {\sbseries NetsurfP-2 secondary structure $Q_8$ \texttt{T}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 66.61) {\sbseries NetsurfP-2 secondary structure $Q_8$ \texttt{C}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 70.45) {\sbseries NetsurfP-2 $\phi$\hspace{.21ex} torsion angle};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 74.29) {\sbseries NetsurfP-2 $\psi$ torsion angle};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 78.13) {\sbseries NetsurfP-2 disorder};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 81.98) {\sbseries PSSM score \texttt{A}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 85.82) {\sbseries PSSM score \texttt{C}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 89.66) {\sbseries PSSM score \texttt{D}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 93.50) {\sbseries PSSM score \texttt{E}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33, 97.34) {\sbseries PSSM score \texttt{F}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,101.18) {\sbseries PSSM score \texttt{G}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,105.02) {\sbseries PSSM score \texttt{H}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,108.86) {\sbseries PSSM score \texttt{I}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,112.70) {\sbseries PSSM score \texttt{K}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,116.55) {\sbseries PSSM score \texttt{L}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,120.39) {\sbseries PSSM score \texttt{M}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,124.23) {\sbseries PSSM score \texttt{N}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,128.07) {\sbseries PSSM score \texttt{P}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,131.91) {\sbseries PSSM score \texttt{Q}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,135.75) {\sbseries PSSM score \texttt{R}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,139.59) {\sbseries PSSM score \texttt{S}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,143.43) {\sbseries PSSM score \texttt{T}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,147.28) {\sbseries PSSM score \texttt{V}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,151.12) {\sbseries PSSM score \texttt{W}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,154.96) {\sbseries PSSM score \texttt{Y}};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,158.80) {\sbseries PSSM score mutation from};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,162.64) {\sbseries PSSM score mutation towards};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,166.48) {\sbseries PSSM score mutation difference};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,170.32) {\sbseries trRosetta closeness centrality};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,174.16) {\sbseries trRosetta betweenness centrality};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,178.01) {\sbseries trRosetta degree centrality};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,181.85) {\sbseries trRosetta load centrality};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,185.69) {\sbseries trRosetta harmonic centrality};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.4] at ( 80.33,189.53) {\sbseries trRosetta clustering coefficient};
	\end{scope}
	\begin{scope}
		\path[clip] (  0.00,  0.00) rectangle (344.26,196.49);
		\node[inner sep=0pt,outer sep=0pt,anchor=south west,rotate=  0.00] at (306.98,  58.71) {
			\pgfimage[width= 14.45pt,height= 72.27pt,interpolate=true]{tikz/tikzdevice/raster/presentation_feature_corr_heatmap_ras1}};
	\end{scope}
	\begin{scope}
		\path[clip] (  0.00,  0.00) rectangle (344.26,196.49);
