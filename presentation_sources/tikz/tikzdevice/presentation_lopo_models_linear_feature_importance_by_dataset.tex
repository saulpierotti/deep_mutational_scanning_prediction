...
\begin{tikzpicture}[x=1pt,y=1pt]
	...
	\begin{scope}
		...
		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,145.38) {\sbseries NetsurfP-2 torsion angles};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,149.89) {\sbseries NetsurfP-2 disorder};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,154.40) {\sbseries Wild-type residue};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,158.91) {\sbseries Mutated residue};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,163.42) {\sbseries NetsurfP-2 solvent accessibility};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,167.93) {\sbseries trRosetta};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,172.44) {\sbseries NetsurfP-2 secondary structure};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,176.95) {\sbseries PSSM};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,181.47) {\sbseries EVcouplings};
	\end{scope}
	\begin{scope}
		\path[clip] (  0.00,  0.00) rectangle (344.26,196.49);
		\definecolor{drawColor}{gray}{0.85}
	...
	\begin{scope}
		...
		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 86.00) {\sbseries NetsurfP-2 torsion angles};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 90.51) {\sbseries NetsurfP-2 disorder};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 95.02) {\sbseries Wild-type residue};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 99.53) {\sbseries Mutated residue};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,104.05) {\sbseries NetsurfP-2 solvent accessibility};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,108.56) {\sbseries trRosetta};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,113.07) {\sbseries NetsurfP-2 secondary structure};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,117.58) {\sbseries PSSM};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72,122.09) {\sbseries EVcouplings};
	\end{scope}
	\begin{scope}
		\path[clip] (  0.00,  0.00) rectangle (344.26,196.49);
		\definecolor{drawColor}{gray}{0.85}
	...
	\begin{scope}
		...
		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 26.62) {\sbseries NetsurfP-2 torsion angles};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 31.14) {\sbseries NetsurfP-2 disorder};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 35.65) {\sbseries Wild-type residue};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 40.16) {\sbseries Mutated residue};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 44.67) {\sbseries NetsurfP-2 solvent accessibility};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 49.18) {\sbseries trRosetta};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 53.69) {\sbseries NetsurfP-2 secondary structure};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 58.20) {\sbseries PSSM};

		\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.45] at ( 88.72, 62.72) {\sbseries EVcouplings};
	\end{scope}
	\begin{scope}
		\path[clip] (  0.00,  0.00) rectangle (344.26,196.49);
		\definecolor{drawColor}{gray}{0.85}
