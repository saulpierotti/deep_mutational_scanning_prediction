...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{minipage}{.3\textwidth}%
			...
			\end{figure}
		\end{minipage}%
		\imgsource{modification of patient icon by Marcel Tisch; zincfinger icon by Simon Dürr; Illumina\_miseq icon by DBCLS; sand-clock icon by Servier; ai icon by Simon Dürr; sigmoid icon by Simon Dürr}
	\end{figure}
\end{frame}
