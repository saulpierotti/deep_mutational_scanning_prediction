...
\begin{frame}
	...
	\begin{figure}
		...
		\imgsource{restriction\_enzyme icon by Simon Dürr; Illumina\_miseq icon by DBCLS; modified stem\_cell\_colony icon by Marcel Tisch}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{minipage}{.4\textwidth}%
			...
			\vspace{1em}%
			\begin{figure}
				\includegraphics[height=4em]{images/paper-chromatography-run.pdf}
				\hspace{1em}%
		...
		\begin{minipage}{.3\textwidth}%
			...
			\end{figure}
		\end{minipage}%
		\imgsource{modified patient icon by Marcel Tisch; zincfinger icon by Simon Dürr; paper-chromatography-run icon by Servier; sand-clock icon by Servier; ai icon by Simon Dürr; sigmoid icon by Simon Dürr}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\footnotesize%
	Illumina\_miseq icon by DBCLS \url{https://togotv.dbcls.jp/en/pics.html} is licensed under CC-BY 4.0 Unported \url{https://creativecommons.org/licenses/by/4.0/}\\[1ex]
	restriction\_enzyme icon by Simon Dürr \url{https://twitter.com/simonduerr} is licensed under CC0 \url{https://creativecommons.org/publicdomain/zero/1.0/}\\[1ex]
	zincfinger icon by Simon Dürr \url{https://twitter.com/simonduerr} is licensed under CC0 \url{https://creativecommons.org/publicdomain/zero/1.0/}\\[1ex]

	stem\_cell\_colony icon by Marcel Tisch \url{https://twitter.com/MarcelTisch} is licensed under CC0 \url{https://creativecommons.org/publicdomain/zero/1.0/}\\[1ex]
	ai icon by Simon Dürr https://twitter.com/simonduerr is licensed under CC0 https://creativecommons.org/publicdomain/zero/1.0/\\[1ex]
	sigmoid icon by Simon Dürr https://twitter.com/simonduerr is licensed under CC0 https://creativecommons.org/publicdomain/zero/1.0/\\[1ex]
\end{frame}
