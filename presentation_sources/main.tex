...
\begin{frame}
	...
	\begin{figure}
		...
		\imgsource{restriction\_enzyme icon by Simon Dürr; Illumina\_miseq icon by DBCLS;\@ modification of stem\_cell\_colony icon by Marcel Tisch}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{minipage}{.3\textwidth}%
			...
			\end{figure}
		\end{minipage}%
		\imgsource{modification of patient icon by Marcel Tisch; zincfinger icon by Simon Dürr; paper-chromatography-run icon by Servier; sand-clock icon by Servier; ai icon by Simon Dürr; sigmoid icon by Simon Dürr}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{minipage}{.3\textwidth}%
			\begin{figure}
				\includegraphics[height=5em]{images/approved.pdf}
			\end{figure}
		\end{minipage}
		\vfill%
		\begin{minipage}{.7\textwidth}%
		...
		\end{minipage}%
		\vspace{3em}
		\imgsource{personal creation; hell-birne-karriere-klettern-licht by mohamed\_hassan}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\end{figure}
		\imgsource{hombre-pensamiento-silueta-4484226 by mohamed\_hassan}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\textcolor{primary_inverse_fg}{ai} icon by Simon Dürr \url{https://twitter.com/simonduerr} is licensed under CC0 \url{https://creativecommons.org/publicdomain/zero/1.0/}\\[1ex]
	...
	\textcolor{primary_inverse_fg}{hombre-pensamiento-silueta} by mohamed\_hassan \url{https://pixabay.com/es/vectors/hombre-pensamiento-silueta-4484226/} is licensed under Simplified Pixabay License \url{https://pixabay.com/service/terms/\#license}\\[1ex]


	\textcolor{primary_inverse_fg}{hell-birne-karriere-klettern-licht} by mohamed\_hassan \url{https://pixabay.com/de/vectors/hell-birne-karriere-klettern-licht-2855120/} is licensed under Simplified Pixabay License \url{https://pixabay.com/service/terms/\#license}\\[1ex]
\end{frame}
