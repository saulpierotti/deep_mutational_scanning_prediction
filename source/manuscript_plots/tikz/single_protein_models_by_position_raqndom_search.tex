% Created by tikzDevice version 0.12.3.1 on 2021-05-25 15:48:47
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.60] at (358.61,193.83) {Fraction of subsampled columns for each tree};
\end{scope}
\begin{scope}
