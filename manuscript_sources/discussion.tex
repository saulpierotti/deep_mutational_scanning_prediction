...
The use of structure-derived features, particularly solvent accessibility \parencite{Savojardo2021} but also, as shown in \autoref{sec:res:feature_imp}, residue contacts, is of paramount importance in the prediction of the effect of mutations.
...
As described in \autoref{sec:mm_feature_importance} collinearity can lead to underestimation of feature importance.
