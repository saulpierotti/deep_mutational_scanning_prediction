...
\usepackage{parskip} % must be before hyperref
\usepackage{geometry}
\usepackage{tabularx}
\usepackage{booktabs}
\usepackage{placeins}
...
\usepackage[nameinlink,capitalise,noabbrev]{cleveref} % must be last and absolutely AFTER hyperref
...
% make urls monospaced (part of url package)
\urlstyle{tt}%
