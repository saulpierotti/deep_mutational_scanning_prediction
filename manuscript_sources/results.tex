...
\begin{table}[p]
	...
	\ttabbox[\textwidth]{%
		\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lllll}%
			...
			\midrule
			\texttt{beta-lactamase} & Naive       & \numrange{0.8887}{0.9035}        & \numrange{0.8568}{0.8732}         \\
			\texttt{WW\_domain}     & Naive       & \numrange{0.6895}{0.7866}        & \numrange{0.6930}{0.7927}         \\
			\texttt{PSD95pdz3}      & Naive       & \numrange{0.7548}{0.8104}        & \numrange{0.7304}{0.7558}         \\
			\texttt{kka2\_1:2}      & Naive       & \numrange{0.7459}{0.7741}        & \numrange{0.7358}{0.7871}         \\
			\texttt{hsp90}          & Naive       & \numrange{0.8302}{0.8630}        & \numrange{0.6622}{0.7015}         \\
			\texttt{Ubiquitin}      & Naive       & \numrange{0.7578}{0.8125}        & \numrange{0.7828}{0.8236}         \\
			\texttt{Pab1}           & Naive       & \numrange{0.8161}{0.8630}        & \numrange{0.7728}{0.8214}         \\
			\texttt{E1\_Ubiquitin}  & Naive       & \numrange{0.7773}{0.8407}        & \numrange{0.6665}{0.7374}         \\
			\texttt{gb1}            & Naive       & \numrange{0.8639}{0.9037}        & \numrange{0.8502}{0.8888}         \\
